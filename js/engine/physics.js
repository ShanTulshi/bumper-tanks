// Circle bodies vs rounded-rect world geometry. Rects: {cx, cy, w, h, r}.
...
// Circle vs solid rounded rect. Returns null or {nx, ny, depth} (normal points
// away from the rect, i.e. the direction to push the circle out).
