// All gameplay tuning lives here. Units are world units (wu); tanks are ~48 wu wide.
...
export const ROT_SPEED = 30; // rad/s (~1720 deg/s)
...
export function randomCallsign(taken: readonly string[] = []): string {
